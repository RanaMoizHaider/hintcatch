import { index } from '@/actions/App/Http/Controllers/ConfigController';
...
import type { Config, PaginatedData } from '@/types/models';
...
export default function ConfigsIndex({ configs, filters }: Props) {
    ...
    return (
        <>
            <SeoHead
                title="All Configs"
                description="Browse all AI agent configurations, rules, and settings."
            />
                            ...
                            <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                                <div>
                                    ...
                                    <p className="mt-2 text-ds-text-secondary">
                                        Browse all configurations, rules, and
                                        settings
                                    </p>
                                </div>
